...
docker run --volumes-from fledge-data -d -p 8081:8081 -p 80:80 -p 1995 fledge:latest

#### Run interactively
docker run --volumes-from fledge-data -it -p 8081:8081 -p 80:80 -p 1995 fledge:latest /bin/bash
